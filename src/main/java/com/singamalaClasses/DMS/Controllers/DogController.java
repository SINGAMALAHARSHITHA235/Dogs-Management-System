 ...
 * 
 */
package com.singamalaClasses.DMS.Controllers;
...
import com.singamalaClasses.DMS.Models.Trainer;
import com.singamalaClasses.DMS.repository.DogRepository;
import com.singamalaClasses.DMS.repository.TrainerRepository;
...
//	}
	...
	public ModelAndView editDogs(Dog dog) {
		dogRepo.save(dog);
